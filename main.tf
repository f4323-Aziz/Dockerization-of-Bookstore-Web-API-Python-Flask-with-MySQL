...
provider "github" {
    token = "xxxxxxxxxxxxxxxxxxxxx" # You should write here your own Github token
...
resource "aws_instance" "tf-docker-ec2" {
    ...
    key_name = "firstkey"
    security_groups = ["aziz-docker-sec-gr-203"] 
    ...
    user_data = <<-EOF
          ...
          FOLDER="https://$TOKEN@raw.githubusercontent.com/f4323-Aziz/bookstore-repo/main/"
